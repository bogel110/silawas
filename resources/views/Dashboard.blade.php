...
@section('content')
    <div class="row g-4 mb-5">
        ...
        <div class="col-md-4">
            <div class="metric-card">
                ...
                <small class="text-muted text-uppercase tracking-wider fw-semibold">Progress</small>
            </div>
        </div>
        <div class="col-md-4">
    ...
    <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
        <div class="p-4 bg-light bg-opacity-50 d-flex justify-content-between align-items-center">
            <div>
                <h4 class="font-headline fw-bold mb-1">Sekolah Binaan</h4>
                <p class="text-muted small mb-0">Top ranking sekolah binaan.</p>
            </div>
        </div>
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0">
                <thead class="bg-light bg-opacity-25">
                    <tr>
                        <th class="px-4 py-3 text-muted text-uppercase fw-bold" style="font-size: 0.65rem;">Urutan</th>
                        <th class="py-3 text-muted text-uppercase fw-bold" style="font-size: 0.65rem;">Nama Sekolah</th>
